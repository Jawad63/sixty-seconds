...
function UpdateProfileAlina() {
   ...
   const userCollectionRef = collection(database, "profileAlina");
   ...
   const updateUser = async (id) => {
      const userDoc = doc(database, "profileAlina", id)
      const newData = {
         name: userName,
         age: userAge,
         gender: userGender,
   ...
   const deleteUser = async (id) => {
      const deleteUserDoc = doc(database, "profileAlina", id);
...
export default UpdateProfileAlina